...
Also, features have been plotted against each other to select more informative ones. For example, we can see clear separation between different categories of roll_belt and pitch_belt features:
...
However, the boosting clasifier was able to achieve 94% accuracy. The training with booting predictor required more time to produce classification, and it was able to correctly classify all 20 instances of testing data ([pml-testing.csv](https://d396qusza40orc.cloudfront.net/predmachlearn/pml-testing.csv)). 
